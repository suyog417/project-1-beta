...
import { BarChart, Check, Globe, Lightbulb, Rocket } from "lucide-react";
...
export default function Home() {
  const whatweOffer: {
    ...
    },
    {
      icon: <Check />,
      description:
        "Data-driven insights for claims analytics and portfolio optimization.",
      img: "/assets/Data_driven_insights.jpg",
    },
    {
      icon: <Check />,
      description:
        "Scalable, technology-driven solutions tailored to insurers’ needs.",
      img: "/assets/Scalable_technology.jpg",
    },
  ];

  const whyChooseGet2Act: {
    icon: React.ReactNode;
    title: string;
    description: string;
  }[] = [
    ...
    },
    {
      ...
      description:
        "From traditional actuarial consulting to cutting-edge data analytics.",
    },
    {
      icon: <Globe color="orange" />,
      title: "Global & Local Expertise",
      description:
        "Deep understanding of international best practices and regional regulations.",
    },
    {
      icon: <Rocket color="orange" />,
      title: "Long-Term Strategic Focus",
      description:
        "We don't just solve immediate problems; we future-proof your business.",
    },
  ];
  return (
    <div className="flex flex-wrap flex-col min-h-screen">
      ...
      <main className="flex-grow flex items-center justify-center bg-[#0074a611] relative overflow-hidden pt-[6.5rem]">
        ...
        <div className="flex md:flex-row flex-col-reverse items-end justify-center max-w-7xl align-bottom gap-2 h-fit py-16 md:py-32 relative z-10">
          ...
          <div className="text-left md:text-left px-4 md:w-3/4 flex flex-col">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 text-center">
                <span className="text-[#0073A6]">Actuarial</span> &{" "}
                <span className="text-[#0073A6]">Data-Driven</span> Solutions
                for a Changing{" "}
                <span className="text-[#0073A6]">Insurance Landscape</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 text-center">
                Empowering insurers with cutting-edge actuarial services and
                data analytics to navigate the evolving insurance landscape.
              </p>
      ...
      <section className="flex justify-center flex-col self-center px-4">
        ...
        >
          <h3 className="text-3xl font-bold text-[#0073A6] text-center py-8">
            What we offer ?
          </h3>
        </motion.div>
      ...
      <section className="justify-center items-center flex lg:flex-row flex-col flex-grow gap-2 py-12 max-w-7xl self-center relative overflow-hidden">
        <div className="text-center md:text-left px-4 md:px-0 lg:px-4 md:w-5/6 flex flex-col relative z-10 text-black">
          <h2 className="text-3xl font-bold  mb-4 text-[#0073A6]">
            Who We Are ?
          </h2>
          <p className="text-lg  mb-8">
            At Get2Act, we are more than just actuarial consultants—we are
            strategic partners in navigating risk, optimizing capital, and
            driving business growth. With expertise spanning across Product
            Pricing, Reserving, Risk-Based Capital (RBC), Embedded Value (EV)
            Modelling, and Data Analytics.
          </p>
          <Link href={"/about"}>
            <p className="text-[#0073A6] hover:underline">Read More About Us</p>
          </Link>
        </div>
        <div className="overflow-hidden w-full md:w-full px-4 relative z-10 md:h-96 h-auto aspect-video">
      ...
      <section className="justify-center items-center flex flex-col flex-grow gap-4 py-12 max-w-7xl self-center px-4">
        ...
        >
          <h3 className="text-3xl font-bold text-[#0073A6] text-center">
            Why Choose Get2Act ?
          </h3>
        </motion.div>
        <AnimatePresence mode="popLayout">
      ...
      <div className="text-center md:text-left px-4 md:w-1/2 flex flex-col self-center py-12">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4 text-center">
            Start Your Learning with<span className="text-[#d7152f]"> Get</span>
            <span className="text-[#e39e0f]">2</span>
            <span className="text-[#517e23]">Learn</span>
          </h1>
          <p className="text-lg text-gray-600 mb-8 text-center">
            Unlock your potential in the actuarial field with Get2Learn.
            <br></br> Start your journey towards a rewarding career.
          </p>
          <div className="flex justify-center">
            <Link href={"/get2learn"}>
      ...
      <section className="justify-center items-center flex flex-col flex-grow gap-4 py-9 bg-[#0074a611]">
        ...
        >
          <h3 className="text-4xl font-bold text-[#0073A6] text-center">
            Ask an Actuary
          </h3>
        </motion.div>

        <p className="text-center px-4">
          Have a thought-provoking actuarial question? <br></br>Post your
          question below, and if it sparks an insightful discussion, we’ll
          feature it on our website!
        </p>
        <Link href={"/askAnActuary"}>
...
function WhatWeOfferCard({
  ...
  return (
    <div className="bg-[#0074a6] rounded-lg flex flex-col items-start text-left">
      ...
      <p className="text-white text-sm text-center font-semibold pb-3 px-3">
        {description}
      </p>
    </div>
  );
