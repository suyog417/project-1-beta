...
export function BlogForm({ blog, onSuccess }: BlogFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = blog?.id
        ? `https://back-get-2-act-git-main-get2act-techs-projects.vercel.app/api/blogs/${blog.id}`
        : "https://back-get-2-act-git-main-get2act-techs-projects.vercel.app/api/blogs/create";
