...
export default function BlogsPage() {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await fetch("https://back-get-2-act-git-main-get2act-techs-projects.vercel.app/api/blogs");
  ...
  const handleDelete = async (id: string) => {
    ...
    if (confirm("Are you sure you want to delete this blog post?")) {
      try {
        const response = await fetch(`https://back-get-2-act-git-main-get2act-techs-projects.vercel.app/api/blogs/${id}`, {
          method: "DELETE",
          headers: {
