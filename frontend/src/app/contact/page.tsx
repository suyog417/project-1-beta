...
export default function ContactPage() {
  ...
  const Dialog = ({ children }: { children: React.ReactNode }) => {
    return (
      ...
      >
        {children}
        <div className="flex flex-row items-end justify-end mt-8">
          <Button
            onClick={(e) => {
      ...
      setDialogContent(
        <Dialog>
          <div className="flex gap-6 flex-col">
            <WarningAmber className="h-32 w-32" />
        ...
        setDialogContent(
          <Dialog>
            <div className="flex gap-6">
              <WarningAmber />
              <h3>
                Form submission failed. Please try again. Status:{" "}
                {response.status}
              </h3>
            </div>
          </Dialog>,
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 w-full">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#0073A6] mb-6">
              Let's Connect
            </h2>
            <p className="text-gray-600 mb-8">
              Have a query related to insurance, risk modelling, or financial
              valuations? We'd love to hear from you. Please use the contact
              form below or reach us directly using the details provided.
            </p>

            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold text-[#0073A6] mb-4">
                  Office Address
                </h3>
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4065.149954688001!2d73.0032396110788!3d19.082464382048872!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c1005266d7ab%3A0xbcb577e9c5937651!2sGet2Act!5e1!3m2!1sen!2sin!4v1740634295568!5m2!1sen!2sin"
                  width="600"
                  height="450"
                  loading="lazy"
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-1 text-gray-600 items-center">
                    ...
                    <a
                      href="https://www.linkedin.com/company/get2act/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      linkedin.com/company/get2act/
                    </a>
                  </div>
                </div>
              </div>
